...
const teamData = [
  ...
  },
  {
    ...
    bio: "Builds and styles the UI components across the project. Detail-oriented and consistent.",
  ...
  },
  {
    ...
    bio: "Handles the core JavaScript logic and DOM interactions. Keeps the code clean and readable.",
  ...
  },
  {
    ...
    bio: "Works on API calls and async data flow for the apps. Focused on error handling and smooth UX.",
